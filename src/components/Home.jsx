                    ...
                    cproducts.map((item, index) => {
                        ...
                        return (
                            <div key={item._id} className="pcard m-3 ">
                                ...
                                <p className="m-2 pname"> {item.pname}  </p>
                                
                                <p className="m-2 pcategory"> {item.category} </p>
                                <h3 className="m-2 pprice"> {item.price} </h3>
                                <p className="m-2 pdesc"> {item.pdesc} </p>
                            </div>
                        )
            ...
            {!issearch && <div className="d-flex justify-content-center flex-wrap">
                {products && products.length > 0 &&
                    products.map((item, index) => {
                        ...
                        return (
                            <div onClick={() => handleProduct(item._id)} key={item._id} className="pcard m-3">
                                ...
                                <p className="m-2 pname"> {item.pname}   </p>
                                <p className="m-2 pcategory">   {item.category} </p>
                                <h3 className="m-2 pprice"> Rs. {item.price} /- </h3>
                                <p className="m-2 pdesc"> {item.pdesc} </p>
                            </div>
                        )
